...
{
    public class FastRunning : GroundMovementState
    {
        private readonly GroundedStateConfiurationg _configuration;

        public FastRunning(IStateSwitcher stateSwitcher, StateMachineData data, Character character) : base(stateSwitcher, data, character)
        {
        ...
        {
            return _configuration.MoveSpeed;
        }
    }
}
